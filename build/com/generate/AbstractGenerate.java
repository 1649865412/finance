...
//			}
			...
			javaPath = StringUtils.replace(projectPath + "/src/", "/", separator);
			logger.info("Java Path: {}", javaPath);
			
			// javaResources路径
			//javaResourcesPath = StringUtils.replace(projectPath + "/src/main/resources/", "/", separator);
			javaResourcesPath = StringUtils.replace(projectPath + "/resources/", "/", separator);
			...
			//testJavaResourcesPath = StringUtils.replace(projectPath + "/resources/", "/", separator);
			...
			webappPath = StringUtils.replace(projectPath + "/WebRoot/", "/", separator);
			logger.info("webapp Path: {}", webappPath);
			
			// 视图文件路径
			//viewPath = StringUtils.replace(projectPath + "/src/main/webapp/WEB-INF/views/", "/", separator);
			viewPath = StringUtils.replace(projectPath + "/WebRoot/WEB-INF/views/", "/", separator);
			...
			model.put("functionName", Resources.TPL_CLASS_NAME);
